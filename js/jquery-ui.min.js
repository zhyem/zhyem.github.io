        ...
        drag: function (t, n) {
          ...
          for (var l = r.snapElements.length - 1; l >= 0; l--) {
            ...
            if (i.snapMode != 'inner') {
              ...
              v &&
                (n.position.top =
                  r._convertPositionTo('relative', { top: p - r.helperProportions.height, left: 0 }).top -
                  r.margins.top),
                m && (n.position.top = r._convertPositionTo('relative', { top: d, left: 0 }).top - r.margins.top),
                g &&
                  (n.position.left =
                    r._convertPositionTo('relative', { top: 0, left: c - r.helperProportions.width }).left -
                    r.margins.left),
            ...
            if (i.snapMode != 'outer') {
              ...
              v && (n.position.top = r._convertPositionTo('relative', { top: p, left: 0 }).top - r.margins.top),
                m &&
                  (n.position.top =
                    r._convertPositionTo('relative', { top: d - r.helperProportions.height, left: 0 }).top -
                    r.margins.top),
                g && (n.position.left = r._convertPositionTo('relative', { top: 0, left: c }).left - r.margins.left),
                y &&
                  (n.position.left =
                    r._convertPositionTo('relative', { top: 0, left: h - r.helperProportions.width }).left -
                    r.margins.left);
            }
            !r.snapElements[l].snapping &&
              (v || m || g || y || b) &&
    ...
    e.widget('ui.resizable', e.ui.mouse, {
      ...
      _mouseStart: function (t) {
        ...
        r.containment && ((o += e(r.containment).scrollLeft() || 0), (u += e(r.containment).scrollTop() || 0)),
          ...
          (this.aspectRatio =
            typeof r.aspectRatio == 'number' ? r.aspectRatio : this.originalSize.width / this.originalSize.height || 1);
  ...
  (function (e, t) {
    e.widget('ui.sortable', e.ui.mouse, {
      ...
      _intersectsWithPointer: function (t) {
        var n =
            this.options.axis === 'x' || e.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height),
          r =
            this.options.axis === 'y' ||
                    ...
                    return o === 'undefined'
                      ...
                      : (o === 'function' && ((s = s.call(this, f)), (o = t.type(s))),
                        s == null && r.empty
                          ? this
                          : (o === 'string' &&
                              ((l = i.exec(s)), l && (s = f + parseFloat(l[2]) * (l[1] === '+' ? 1 : -1))),
                            (a[r.idx] = s),
                            this[u](a)));
                  };
                });
      ...
      _generateMonthYearHeader: function (e, t, n, r, i, s, o, u) {
        ...
        if (!e.yearshtml) {
          ...
          if (s || !f) c += '<span class="ui-datepicker-year">' + n + '</span>';
            ...
            for (; b <= w; b++)
              e.yearshtml +=
                '<option value="' + b + '"' + (b == n ? ' selected="selected"' : '') + '>' + b + '</option>';
        ...
        (function (e) {
          ...
          e.fn.position = function (r) {
            ...
            return (
              ...
              /^\d/.test(i[1]) && (i[1] = '+' + i[1]),
              s.length === 1 &&
                (/left|center|right/.test(s[0]) ? (s[1] = 'center') : ((s[1] = s[0]), (s[0] = 'center'))),
                ...
                a.options.range === !0 &&
                  (a.orientation === 'horizontal'
                    ? (r === 0 && a.range.stop(1, 1)[f ? 'animate' : 'css']({ left: n + '%' }, u.animate),
                      r === 1 &&
                        a.range[f ? 'animate' : 'css']({ width: n - t + '%' }, { queue: !1, duration: u.animate }))
                    : (r === 0 && a.range.stop(1, 1)[f ? 'animate' : 'css']({ bottom: n + '%' }, u.animate),
                      r === 1 &&
                        a.range[f ? 'animate' : 'css']({ height: n - t + '%' }, { queue: !1, duration: u.animate }))),
                (t = n);
            })
          : ((r = this.value()),
            (i = this._valueMin()),
      ...
      e.uiBackCompat !== !1 &&
        ...
        (function () {
          ...
          e.widget('ui.tabs', e.ui.tabs, {
            ...
            _cookie: function (n) {
              ...
              return (
                arguments.length && (r.push(n === !1 ? -1 : n), r.push(this.options.cookie)), e.cookie.apply(null, r)
              );
            },
            _refresh: function () {
        ...
        e.widget('ui.tabs', e.ui.tabs, {
          _trigger: function (t, n, r) {
            var i = e.extend({}, r);
            return (
              t === 'load' && ((i.panel = i.panel[0]), (i.tab = i.tab.find('.ui-tabs-anchor')[0])), this._super(t, n, i)
            );
          },
        }),
        e.widget('ui.tabs', e.ui.tabs, {
